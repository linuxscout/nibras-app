 ...
 */
public class TabSt1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.st_semestre1, container, false);
    ...
    public String ratrapageOrNot(double resultat){
        ...
        {
            module1 = " -"+getResources().getString(R.string.math1)+"\n";
            //module1 = "-Analyse1\n" ;
        }
        if(Double.parseDouble(e2.getText().toString())<10)
        {
            module2 = " -"+getResources().getString(R.string.physique1)+"\n";
            //module2 = "-Algebre1\n" ;
        }
        if(Double.parseDouble(e3.getText().toString())<10)
        {
            module3 = " -"+getResources().getString(R.string.struc_matiere)+"\n";
            //module3 = "-Algorithme\n" ;
        }
        if(Double.parseDouble(e4.getText().toString())<10)
        {
            module4 = " -"+getResources().getString(R.string.informatique1)+"\n";
            //module4 = "-Bureautique\n" ;
        }
        if(Double.parseDouble(e5.getText().toString())<10)
        {
            module5 = " -"+getResources().getString(R.string.tp_physique1)+"\n";
            //module5 = "-Français\n" ;
        }
        if(Double.parseDouble(e6.getText().toString())<10)
        {
            module6 = " -"+getResources().getString(R.string.tp_chimie1)+"\n";
            //module6 = "-Codage\n" ;
        }
        if(Double.parseDouble(e7.getText().toString())<10)
        {
            module7 = " -"+getResources().getString(R.string.methdo_redac)+"\n";
            //module7 = "-Economie\n" ;
        }
        if(Double.parseDouble(e8.getText().toString())<10)
        {
            module8 = " -"+getResources().getString(R.string.les_matiere_st1)+"\n";
            //module8 = "-Anglais\n" ;
        }
        if(Double.parseDouble(e9.getText().toString())<10)
        {
            module9 = " -"+getResources().getString(R.string.fr_en1)+"\n";
            //module9 = "-Anglais\n" ;
        }
