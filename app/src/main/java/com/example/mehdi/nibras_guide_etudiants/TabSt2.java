 ...
 */
public class TabSt2 extends Fragment {
    ...
    public int tabCoeff[] = {3,3,3,2,1,1,1,1,2};
    public int tabCoeffUF[]= {3,3,3};
    public int tabCoeffUM[]= {2,1,1,1};
    public int tabCoeffUD[]= {1};
    public int tabCoeffUT[]= {2};
    public int totaleCoeff = 17;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.st_semestre2, container, false);
        ...
        tabNoteUM = new double[4];
        tabNoteUD = new double[1];
    ...
    public double calculeUM(){
        ...
        if(e7.getText().toString().equals("")){
            ...
            tabNoteUM[3] = Double.parseDouble(e7.getText().toString());
        }
    ...
    public double calculeUD(){
        ...
        if(e8.getText().toString().equals("")){
            ...
            tabNoteUD[0] = Double.parseDouble(e8.getText().toString());
        }
    ...
    public String ratrapageOrNot(double resultat){
        ...
        {
            module1 = " -"+getResources().getString(R.string.math2)+"\n";
            //module1 = "-Analyse1\n" ;
        }
        if(Double.parseDouble(e2.getText().toString())<10)
        {
            module2 = " -"+getResources().getString(R.string.physique2)+"\n";
            //module2 = "-Algebre1\n" ;
        }
        if(Double.parseDouble(e3.getText().toString())<10)
        {
            module3 = " -"+getResources().getString(R.string.thermodinamique)+"\n";
            //module3 = "-Algorithme\n" ;
        }
        if(Double.parseDouble(e4.getText().toString())<10)
        {
            module4 = " -"+getResources().getString(R.string.informatique2)+"\n";
            //module4 = "-Bureautique\n" ;
        }
        if(Double.parseDouble(e5.getText().toString())<10)
        {
            module5 = " -"+getResources().getString(R.string.tp_physique2)+"\n";
            //module5 = "-Français\n" ;
        }
        if(Double.parseDouble(e6.getText().toString())<10)
        {
            module6 = " -"+getResources().getString(R.string.tp_chimie2)+"\n";
            //module6 = "-Codage\n" ;
        }
        if(Double.parseDouble(e7.getText().toString())<10)
        {
            module7 = " -"+getResources().getString(R.string.methdo_present)+"\n";
            //module7 = "-Economie\n" ;
        }
        if(Double.parseDouble(e8.getText().toString())<10)
        {
            module8 = " -"+getResources().getString(R.string.les_matiere_st2)+"\n";
            //module8 = "-Anglais\n" ;
        }
        if(Double.parseDouble(e9.getText().toString())<10)
        {
            module9 = " -"+getResources().getString(R.string.fr_en2)+"\n";
            //module9 = "-Anglais\n" ;
        }
