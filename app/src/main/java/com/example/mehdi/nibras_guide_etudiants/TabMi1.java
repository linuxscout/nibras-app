 ...
 */
public class TabMi1 extends Fragment {
    ...
    public int tabCoeff[] = {4,2,4,1,1,2,2,1};
    public int tabCoeffUF[]= {4,2,4};
    public int tabCoeffUM[]= {1,1};
    public int tabCoeffUD[]= {2,2};
    public int tabCoeffUT[]= {1};
    public int totaleCoeff = 17;
    public int totaleCoeffUF = 10;
    public int totaleCoeffUM = 2;
    public int totaleCoeffUD = 4;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.mi_semestre1, container, false);
...
effacer(v);
    ...
    public String ratrapageOrNot(double resultat){
        ...
        {
            module1 = " -"+getResources().getString(R.string.analyse1)+"\n";
            //module1 = "-Analyse1\n" ;
        }
        if(Double.parseDouble(e2.getText().toString())<10)
        {
            module2 = " -"+getResources().getString(R.string.algebre1)+"\n";
            //module2 = "-Algebre1\n" ;
        }
        if(Double.parseDouble(e3.getText().toString())<10)
        {
            module3 = " -"+getResources().getString(R.string.algorithme)+"\n";
            //module3 = "-Algorithme\n" ;
        }
        if(Double.parseDouble(e4.getText().toString())<10)
        {
            module4 = " -"+getResources().getString(R.string.tp_bueautique)+"\n";
            //module4 = "-Bureautique\n" ;
        }
        if(Double.parseDouble(e5.getText().toString())<10)
        {
            module5 = " -"+getResources().getString(R.string.francais)+"\n";
            //module5 = "-Français\n" ;
        }
        if(Double.parseDouble(e6.getText().toString())<10)
        {
            module6 = " -"+getResources().getString(R.string.codage)+"\n";
            //module6 = "-Codage\n" ;
        }
        ...
        {
            module8 = " -"+getResources().getString(R.string.anglais)+"\n";
            //module8 = "-Anglais\n" ;
        }
