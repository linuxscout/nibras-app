 ...
 */
public class TabSm2 extends Fragment {
    ...
    public int tabCoeff[] = {3,3,3,1,1,2,1,1,1};
    public int tabCoeffUF[]= {3,3,3};
    public int tabCoeffUM[]= {1,1,2};
    public int tabCoeffUD[]= {1,1};
    public int tabCoeffUT[]= {1};
    public int totaleCoeff = 16;
    public int totaleCoeffUF = 9;
    public int totaleCoeffUM = 5;
    public int totaleCoeffUD = 1;
    public int totaleCoeffUT = 1;
    public int id[] = {R.id.editText1,R.id.editText2,R.id.editText3,R.id.editText4,R.id.editText5,R.id.editText6,R.id.editText7,R.id.editText8,R.id.editText9};

    @Override
    public View onCreateView(LayoutInflater inflater,
                             @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View v = inflater.inflate(R.layout.sm_semestre2, container, false);
        ...
        tabNote = new double[9];
        tabNoteUF = new double[3];
        tabNoteUM = new double[3];
    ...
    public double calcule(){
        ...
        if(e9.getText().toString().equals("")){
            ...
            tabNote[8] = Double.parseDouble(e9.getText().toString());
    ...
    public double calculeUM(){
        ...
        if(e6.getText().toString().equals("")){
            ...
            tabNoteUM[2] = Double.parseDouble(e6.getText().toString());
        }
    ...
    public double calculeUD(){
        ...
        if(e7.getText().toString().equals("")){
            ...
            tabNoteUD[0] = Double.parseDouble(e7.getText().toString());
        }
        ...
        if(e8.getText().toString().equals("")){
            ...
            tabNoteUD[1] = Double.parseDouble(e8.getText().toString());
        }
    ...
    public double calculeUT(){
        ...
        if(e9.getText().toString().equals("")){
            ...
            tabNoteUT[0] = Double.parseDouble(e9.getText().toString());
        }
    ...
    public String ratrapageOrNot(double resultat){
        String str,module1 ="",module2="",module3="",module4="",module5="",module6="",module7="",module8="",module9="";
        String allModule;
        if(Double.parseDouble(e1.getText().toString())<10)
        {
            module1 = " -"+getResources().getString(R.string.math_sm2)+"\n";
            //module1 = "-Analyse1\n" ;
        }
        if(Double.parseDouble(e2.getText().toString())<10)
        {
            module2 = " -"+getResources().getString(R.string.physique_sm2)+"\n";
            //module2 = "-Algebre1\n" ;
        }
        if(Double.parseDouble(e3.getText().toString())<10)
        {
            module3 = " -"+getResources().getString(R.string.chimie_sm2)+"\n";
            //module3 = "-Algorithme\n" ;
        }
        if(Double.parseDouble(e4.getText().toString())<10)
        {
            module4 = " -"+getResources().getString(R.string.tp_physique_sm2)+"\n";
            //module4 = "-Bureautique\n" ;
        }
        if(Double.parseDouble(e5.getText().toString())<10)
        {
            module5 = " -"+getResources().getString(R.string.tp_chimie_sm2)+"\n";
            //module5 = "-Français\n" ;
        }
        if(Double.parseDouble(e6.getText().toString())<10)
        {
            module6 = " -"+getResources().getString(R.string.inf_sm2)+"\n";
            //module6 = "-Codage\n" ;
        }
        if(Double.parseDouble(e7.getText().toString())<10)
        {
            module7 = " -"+getResources().getString(R.string.economie)+"\n";
            //module7 = "-Economie\n" ;
        }
        if(Double.parseDouble(e8.getText().toString())<10)
        {
            module8 = " -"+getResources().getString(R.string.histoire_sience)+"\n";
            //module8 = "-Anglais\n" ;
        }
        if(Double.parseDouble(e9.getText().toString())<10)
        {
            module9 = " -"+getResources().getString(R.string.langue2)+"\n";
            //module9 = "-Anglais\n" ;
        }

        allModule = module1+module2+module3+module4+module5+module6+module7+module8+module9;
        if (resultat>=10){
